    ...
    <div className="bg-white py-16">
      <div className="w-11/12 lg:w-9/12 mx-auto">
        ...
        <p className="text-slate-950 text-center font-semibold text-lg mb-4">
          Living an extraordinary life means shaping it on your terms, filled
          with deep meaning and significant impact. Fueled by the quest for
          excellence and a strong sense of purpose, Shahriar Khan has motivated
          millions to dream boldly and strive for greater heights.
        </p>
